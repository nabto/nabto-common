...
enum {
    ...
    NABTO_STREAM_EXTENSION_NONCE            = 0x1007,
    NABTO_STREAM_EXTENSION_NONCE_RESPONSE   = 0x1008,
    NABTO_STREAM_EXTENSION_NONCE_CAPABILITY = 0x1009
};

#define NABTO_STREAM_NONCE_SIZE 8
